...
static void threadMessage1(String message) {
    ...
    private static class MessageLoop implements Runnable { 
        @Override
        public void run() {
            ArrayList importantInfo = read("C:\\Users\\66931\\Documents\\NetBeansProjects\\CSS226-master (2)\\CSS226-master\\Task1\\test.txt");
            try {
    ...
    public static void main(String[] args) {
        ...
        while (t.isAlive()) {
            try {
                ArrayList words = read("C:\\Users\\66931\\Documents\\NetBeansProjects\\CSS226-master (2)\\CSS226-master\\Task1\\test.txt");
